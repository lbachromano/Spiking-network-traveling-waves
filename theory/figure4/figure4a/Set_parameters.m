%Parameters as in 16 june loong tau
clear param
alpha=sqrt(2)*abs(zeta(1/2));

param.tau0=1e-4; 
param.velocity= 300; %mm/s which is 0.3 mm/ms, 

param.l_ee=0.380;    %Let us use mm
param.l_ei=0.250;    %Let us use mm
param.l_ie=0.250;    %Let us use mm
param.l_ii=0.250;    %Let us use mm
...
param.nt_pop_average = 0.8*nt_alpha_E+0.2*nt_alpha_I;
